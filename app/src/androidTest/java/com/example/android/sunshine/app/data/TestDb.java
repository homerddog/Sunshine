...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        long locationRowId = db.insert(WeatherContract.LocationEntry.TABLE_NAME,
                null, testValues);
        ...
        assertTrue("Error: No Records returned for location query", locationCursor.moveToFirst());
